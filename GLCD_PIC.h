...
const unsigned char INST_NOP = 0x00;         // Empty processor cycle
const unsigned char INST_SWRESET = 0x01;     // All registers to default state
const unsigned char INST_SLPIN = 0x10;       // Enter sleep mode
const unsigned char INST_SLPOUT = 0x11;      // Exit sleep mode
const unsigned char INST_PTLON = 0x12;       // Partial mode on
const unsigned char INST_NORON = 0x13;       // Partial mode off (normal)
const unsigned char INST_INVOFF = 0x20;      // Display inversion off
const unsigned char INST_INVON = 0x21;       // Display inversion on
const unsigned char INST_GAMSET = 0x26;      // Set gamma
const unsigned char INST_DISPOFF = 0x28;     // Turn off display
const unsigned char INST_DISPON = 0x29;      // Turn on display
const unsigned char INST_CASET = 0x2A;       // Set column address
const unsigned char INST_RASET = 0x2B;       // Set row address
const unsigned char INST_RAMWR = 0x2C;       // Enables RAM writes
const unsigned char INST_PTLAR = 0x30;       // Partial start/end address
const unsigned char INST_TEOFF = 0x34;       // Tearing effect off
const unsigned char INST_TEON = 0x35;        // Tearing effect on
const unsigned char INST_MADCTL  = 0x36;     // Memory data access control
const unsigned char INST_IDMOFF = 0x38;      // Idle mode off
const unsigned char INST_IDMON = 0x39;       // Idle mode on
const unsigned char INST_COLMOD = 0x3A;      // Interface pixel format
const unsigned char INST_FRMCTR1 = 0xB1;     // Frame rate control (normal mode/full colors)
const unsigned char INST_FRMCTR2 = 0xB2;     // Frame rate control (idle mode/8-colors)
const unsigned char INST_FRMCTR3 = 0xB3;     // Frame rate control (partial mode/full colors)
const unsigned char INST_INVCTR = 0xB4;      // Display inversion control
const unsigned char INST_PWCTR1 = 0xC0;      // Power control1
const unsigned char INST_PWCTR2 = 0xC1;      // Power control2
const unsigned char INST_PWCTR3 = 0xC2;      // Power control3
const unsigned char INST_PWCTR4 = 0xC3;      // Power control4
const unsigned char INST_PWCTR5 = 0xC4;      // Power control5
const unsigned char INST_VMCTR1 = 0xC5;      // VCOM control 1
const unsigned char INST_VMOFCTR2 = 0xC7;    // VCOM control 2	
